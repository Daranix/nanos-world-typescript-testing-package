...
declare namespace NanosWorldWeapons {
    ...
    function AR4(location: Vector, rotation: Rotator): Weapon;
    function Moss500(location: Vector, rotation: Rotator): Weapon;
    function AP5(location: Vector, rotation: Rotator): Weapon;
    function SMG11(location: Vector, rotation: Rotator): Weapon;
}